#fake Makefile for Molecular Maddness, to support the common
...
clean:
	...
	rm -f Molecular Maddness/*~
	rm -rf bin develop-eggs eggs parts .installed.cfg Molecular Maddness.egg-info
...
# push changes
push:
	#bzr push lp:Molecular Maddness
	svn commit
