...
METADATA = {
    ...
    'version':          '0.0.1',
    'license':          'GPL',
    'description':      '2D puzzle game. Move molecules to thwart a mad scientist.',
    'author':           'CrazyPyro (Neil Funk)',
    #'author_email':     '',
    ...
    'classifiers':      [
            ...
            'Topic :: Software Development :: Libraries :: kivy',
